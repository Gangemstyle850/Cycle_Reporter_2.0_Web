                ...
                //Database Mumbo-Jumbo (The Important Stuffs)
                    ...
                    //Run Insert Query On Selected Database And Table
                        if (mysqli_query($dbc, $sql) == true){
                            print ("Submition Was Successful!!!<br>Your Report ID Is: "); print('"'); print("<a href='/view/indiv.php?".$id."'>".$id."</a>"); print('"'); print("!<br>");
                        }
                        else{
                            print ("Failed To Submit!!! Please Wait And Try Again, Or Contact The Site Administrator (Info On <a href='/contact' target='_blank'>Contact Page</a>) If The Problem Persists, And Please Include, ERROR CODE: 3<br>");
